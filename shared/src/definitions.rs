...
pub const CONNECTION_ENDPOINT: u16      = 50124;
...
pub const PADDING_FREQ: u64             = 15;
pub const DELTA_TIME: f32               = 1.0 / READ_FREQ as f32;
pub const SUP_BAND: u16                 = 850; // Schmitt Trigger bands
pub const LOW_BAND: u16                 = 650; // Schmitt Trigger bands
...
pub const WHEEL_SENS: f32               = 40.0;
pub const PAN_SENS: f32                 = 40.0;
